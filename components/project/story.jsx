    ...
    <div className="relative py-16 bg-white overflow-hidden">
      ...
      <div className="relative px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
          <p>
          The first stage of the graphene bulb design project consisted of finding <strong>technical solutions</strong> 
          that would enable the construction of a new product in a patented technology, which thus far had not been used 
          for commercial purposes. Specialists from various fields, including engineers specializing in laser technology, 
          were involved in the project. The project turned out to be quite a <strong>challenge </strong>as it was impossible to use components 
          available on the market. After constructing a dedicated laser and estimating the measurements of the target product, 
          it was time for a concept design. 
          </p>
          <ul>
            <li>The light bulb's design</li>
            <li>The main goal of the materials selection policy is to describe the list of materials that are necessary to manufacture a new product, along with the list of suppliers and the criteria for assessing the quality of materials and their application.</li>
            <li>The presented materials policy is applicable for the production of individual light bulbs.</li>
          </ul>
          <p>
